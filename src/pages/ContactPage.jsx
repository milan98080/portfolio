        ...
        <div className='w-[85%] h-[70dvh] my-12 bg-neutral-800/50 rounded-2xl border border-neutral-400 py-2 md:py-10 lg:py-20 flex flex-wrap overflow-scroll'>
          ...
          <form ref={form} onSubmit={sendEmail} className='form w-full md:w-[60%] pl-4 pr-4 md:pr-0 md:pl-24'>
            ...
            <div className=' w-full flex'>
              <input required minLength={3} type='text' name='user_name' id='name' placeholder='Name' className='w-[40%] bg-neutral-500 border rounded-xl border-neutral-400 text-white text-xl focus:outline-none focus:border-white mt-8 mr-2 p-2' />
              <input required type='email' name='user_email' id='email' placeholder='Email' className='w-[60%] bg-neutral-500 border rounded-xl border-neutral-400 text-white text-xl focus:outline-none focus:border-white mt-8 p-2' />
            </div>
